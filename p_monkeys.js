...
class MonkeySystem extends ParticleSystem {
...
class RocketParticle extends Particle {
  ...
  draw(p, drawDebug = false) {
    ...
    */
    p.textSize(23);
    p.text(emoji, 0, -40 * this.turnStrength);
    p.endShape();
    ...
    for (var i = 0; i < flameCount; i++) {
      ...
      p.fill(300 - pct * 50, 105, 70);
      p.noStroke();
      p.ellipse(-pct * 100, pct * 3 * Math.sin(i * 3 + cycle), r * 27, r * 65);
    }
